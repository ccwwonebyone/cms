...
<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
<span class="glyphicon glyphicon-warning-sign"></span>	注意</span> 
你已发送&nbsp;<font color="#009900"><strong><?php echo $info['1'];?></strong></font>&nbsp;条短信,还有&nbsp;<font color="#CC0000"><strong><?php echo $info['0'];?></strong></font>&nbsp;条短信未使用！
</div>


<span style="float:right">
<a href="http://pay.cmseasy.cn/reg.php" target="_blank" class="btn btn-navy">注册</a>
<a href="<?php echo $base_url;?>/index.php?case=config&act=system&set=sms&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-dodgerblue">设置</a>
...
<form method="post" action="<?php echo url('sms/manage');?>">
<div class="row">
...
2、注册用户后，将用户名和密码，填写在<a href="<?php echo $base_url;?>/index.php?case=config&act=system&set=sms&admin_dir=<?php echo get('admin_dir');?>&site=default" target="_blank" style="color:#009900">短信设置</a>的账户和密码里面；</br>
3、然后进入<a href="<?php echo $base_url;?>/index.php?case=sms&act=manage&admin_dir=<?php echo get('admin_dir');?>&site=default" target="_blank" style="color:#009900">短信管理</a>界面，点击充值，可以按自己需要选择充值数量，最低充值人民币8角；</br>
4、最后进入<a href="<?php echo $base_url;?>/index.php?case=config&act=system&set=sms&admin_dir=<?php echo get('admin_dir');?>&site=default" target="_blank" style="color:#009900">短信设置</a>，设置好短信发送的条件；</br>
