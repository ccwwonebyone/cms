...
<input class="btn btn-primary" type="button" value=" 添加标签" onclick="javascript:window.location.href='index.php?case=table&act=add&table=tag&admin_dir=<?php echo get('admin_dir');?>'" />
